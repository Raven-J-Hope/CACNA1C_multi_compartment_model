...
# used in the dissertation Results section.
#
...
# VC extraction
# ------------------------------------------------------------
# These column names match the current VC_raw_data.csv generated by the dissertation VC script.
...
# Optional check: peak BK values, not necessarily reported in the final text.
