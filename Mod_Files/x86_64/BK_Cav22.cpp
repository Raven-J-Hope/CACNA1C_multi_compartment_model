...
#define nrn_init _nrn_init__BK_Cav22
#define _nrn_initial _nrn_initial__BK_Cav22
#define nrn_cur _nrn_cur__BK_Cav22
#define _nrn_current _nrn_current__BK_Cav22
#define nrn_jacob _nrn_jacob__BK_Cav22
#define nrn_state _nrn_state__BK_Cav22
#define _net_receive _net_receive__BK_Cav22 
#define rates rates__BK_Cav22 
#define state state__BK_Cav22 
...
#define inca _ml->template fpfield<15>(_iml)
#define inca_columnindex 15
...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 {"setdata_BK_Cav22", _hoc_setdata},
 {"peakab_BK_Cav22", _hoc_peakab},
 {"peaka_BK_Cav22", _hoc_peaka},
 {"rates_BK_Cav22", _hoc_rates},
 {"shiftab_BK_Cav22", _hoc_shiftab},
 {"shifta_BK_Cav22", _hoc_shifta},
 {"taufunc_BK_Cav22", _hoc_taufunc},
 {0, 0}
};
...
#define peakab peakab_BK_Cav22
#define peaka peaka_BK_Cav22
#define shiftab shiftab_BK_Cav22
#define shifta shifta_BK_Cav22
#define taufunc taufunc_BK_Cav22
...
#define tau tau_BK_Cav22
 ...
 {"ca0_BK_Cav22", "mM"},
 {"tau_BK_Cav22", "ms"},
 {"B_BK_Cav22", "mM-cm2/mA-ms"},
 {"diff_BK_Cav22", "1"},
 {"gakbar_BK_Cav22", "S/cm2"},
 {"gabkbar_BK_Cav22", "S/cm2"},
 {"ik_BK_Cav22", "mA/cm2"},
 {"gak_BK_Cav22", "S/cm2"},
 {"gabk_BK_Cav22", "S/cm2"},
 {"atau_BK_Cav22", "ms"},
 ...
 {"base_BK_Cav22", &base_BK_Cav22},
 {"ca0_BK_Cav22", &ca0_BK_Cav22},
 {"tau_BK_Cav22", &tau_BK_Cav22},
 {"B_BK_Cav22", &B_BK_Cav22},
 {0, 0}
};
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"inca"} /* 15 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 BK_Cav22 /home/raven/PycharmProjects/Masters/Mod_Files/BK_Cav22.mod\n");
...
/*CVODE*/
 ...
 /*END CVODE*/
 static int state (_internalthreadargsproto_) { {
    ca_i = ca_i + (1. - exp(dt*(( - ( ( 1.0 ) ) / tau ))))*(- ( ( - B )*( inca ) - ( ( ( - ca0 ) ) ) / tau ) / ( ( - ( ( 1.0 ) ) / tau ) ) - ca_i) ;
   acai = ca_i / diff ;
   if ( acai < ca0 ) {
     acai = ca0 ;
     }
...
static void _hoc_rates(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_BK_Cav22. Requires prior call to setdata_BK_Cav22 and that the specified mechanism instance still be in existence.", NULL);
  }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/raven/PycharmProjects/Masters/Mod_Files/BK_Cav22.mod";
  ...
  "\n"
  ": Mar 2026 - made Cav22 specific\n"
  "\n"
  "NEURON {\n"
  "	SUFFIX BK_Cav22\n"
  "	USEION k READ ek WRITE ik\n"
  "	USEION nca READ inca VALENCE 0\n"
  ...
  "\n"
  "DERIVATIVE state {\n"
  "	: convert Cav2.2 current into local nanodomain Ca signal\n"
  "	ca_i' = -B * inca - (ca_i - ca0) / tau\n"
  "\n"
  "	acai = ca_i / diff\n"
  "	if (acai < ca0) {\n"
  "		acai = ca0\n"
