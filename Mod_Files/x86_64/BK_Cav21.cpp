...
#define nrn_init _nrn_init__BK_Cav21
#define _nrn_initial _nrn_initial__BK_Cav21
#define nrn_cur _nrn_cur__BK_Cav21
#define _nrn_current _nrn_current__BK_Cav21
#define nrn_jacob _nrn_jacob__BK_Cav21
#define nrn_state _nrn_state__BK_Cav21
#define _net_receive _net_receive__BK_Cav21 
#define rates rates__BK_Cav21 
#define state state__BK_Cav21 
...
#define ipca _ml->template fpfield<15>(_iml)
#define ipca_columnindex 15
...
#define _ion_ipca *(_ml->dptr_field<3>(_iml))
#define _p_ion_ipca static_cast<neuron::container::data_handle<double>>(_ppvar[3])
...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 {"setdata_BK_Cav21", _hoc_setdata},
 {"peakab_BK_Cav21", _hoc_peakab},
 {"peaka_BK_Cav21", _hoc_peaka},
 {"rates_BK_Cav21", _hoc_rates},
 {"shiftab_BK_Cav21", _hoc_shiftab},
 {"shifta_BK_Cav21", _hoc_shifta},
 {"taufunc_BK_Cav21", _hoc_taufunc},
 {0, 0}
};
...
#define peakab peakab_BK_Cav21
#define peaka peaka_BK_Cav21
#define shiftab shiftab_BK_Cav21
#define shifta shifta_BK_Cav21
#define taufunc taufunc_BK_Cav21
...
#define B B_BK_Cav21
 double B = 0.15;
#define base base_BK_Cav21
 double base = 4;
#define ca0 ca0_BK_Cav21
 double ca0 = 7e-05;
#define tau tau_BK_Cav21
 double tau = 8;
 ...
 {"ca0_BK_Cav21", "mM"},
 {"tau_BK_Cav21", "ms"},
 {"B_BK_Cav21", "mM-cm2/mA-ms"},
 {"diff_BK_Cav21", "1"},
 {"gakbar_BK_Cav21", "S/cm2"},
 {"gabkbar_BK_Cav21", "S/cm2"},
 {"ik_BK_Cav21", "mA/cm2"},
 {"gak_BK_Cav21", "S/cm2"},
 {"gabk_BK_Cav21", "S/cm2"},
 {"atau_BK_Cav21", "ms"},
 ...
 {"base_BK_Cav21", &base_BK_Cav21},
 {"ca0_BK_Cav21", &ca0_BK_Cav21},
 {"tau_BK_Cav21", &tau_BK_Cav21},
 {"B_BK_Cav21", &B_BK_Cav21},
 {0, 0}
};
...
static void nrn_alloc(Prop* _prop) {
 ...
 prop_ion = need_memb(_pca_sym);
 	_ppvar[3] = _nrn_mechanism_get_param_handle(prop_ion, 3); /* ipca */
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"ipca"} /* 15 */,
                                       ...
                                       _nrn_mechanism_field<double*>{"_ion_ipca", "pca_ion"} /* 3 */,
                                       _nrn_mechanism_field<int>{"_cvode_ieq", "cvodeieq"} /* 4 */);
  hoc_register_prop_size(_mechtype, 21, 5);
  hoc_register_dparam_semantics(_mechtype, 0, "k_ion");
  hoc_register_dparam_semantics(_mechtype, 1, "k_ion");
  hoc_register_dparam_semantics(_mechtype, 2, "k_ion");
  hoc_register_dparam_semantics(_mechtype, 3, "pca_ion");
  hoc_register_dparam_semantics(_mechtype, 4, "cvodeieq");
 	hoc_register_cvode(_mechtype, _ode_count, _ode_map, _ode_spec, _ode_matsol);
 	hoc_register_tolerance(_mechtype, _hoc_state_tol, &_atollist);
 
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 BK_Cav21 /home/raven/PycharmProjects/Masters/Mod_Files/BK_Cav21.mod\n");
...
/*CVODE*/
 ...
 /*END CVODE*/
 static int state (_internalthreadargsproto_) { {
    ca_i = ca_i + (1. - exp(dt*(( - ( ( 1.0 ) ) / tau ))))*(- ( ( - B )*( ipca ) - ( ( ( - ca0 ) ) ) / tau ) / ( ( - ( ( 1.0 ) ) / tau ) ) - ca_i) ;
   acai = ca_i / diff ;
   if ( acai < ca0 ) {
     acai = ca0 ;
     }
...
static void _hoc_rates(void) {
 ...
 Datum* _ppvar; Datum* _thread; NrnThread* _nt;
  ...
  if(!_prop_id) {
    hoc_execerror("No data for rates_BK_Cav21. Requires prior call to setdata_BK_Cav21 and that the specified mechanism instance still be in existence.", NULL);
  }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/raven/PycharmProjects/Masters/Mod_Files/BK_Cav21.mod";
