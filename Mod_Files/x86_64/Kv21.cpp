...
#define alpham _ml->template fpfield<6>(_iml)
#define alpham_columnindex 6
#define betam _ml->template fpfield<7>(_iml)
#define betam_columnindex 7
#define alphah _ml->template fpfield<8>(_iml)
#define alphah_columnindex 8
#define betah _ml->template fpfield<9>(_iml)
#define betah_columnindex 9
...
#define Dh _ml->template fpfield<13>(_iml)
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"alpham"} /* 6 */,
                                       _nrn_mechanism_field<double>{"betam"} /* 7 */,
                                       _nrn_mechanism_field<double>{"alphah"} /* 8 */,
                                       _nrn_mechanism_field<double>{"betah"} /* 9 */,
                                       _nrn_mechanism_field<double>{"hInf"} /* 10 */,
                                       _nrn_mechanism_field<double>{"hTau"} /* 11 */,
                                       _nrn_mechanism_field<double>{"Dm"} /* 12 */,
                                       _nrn_mechanism_field<double>{"Dh"} /* 13 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 Kv21 /home/raven/PycharmProjects/Masters_model/Mod_Files_Beining_2017/Kv21.mod\n");
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/raven/PycharmProjects/Masters_model/Mod_Files_Beining_2017/Kv21.mod";
