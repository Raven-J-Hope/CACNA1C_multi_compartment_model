...
#define nrn_init _nrn_init__Kv33
#define _nrn_initial _nrn_initial__Kv33
#define nrn_cur _nrn_cur__Kv33
#define _nrn_current _nrn_current__Kv33
#define nrn_jacob _nrn_jacob__Kv33
#define nrn_state _nrn_state__Kv33
#define _net_receive _net_receive__Kv33 
#define rates rates__Kv33 
#define states states__Kv33 
...
#define am _ml->template fpfield<10>(_iml)
#define am_columnindex 10
#define bm _ml->template fpfield<11>(_iml)
#define bm_columnindex 11
#define ah _ml->template fpfield<12>(_iml)
#define ah_columnindex 12
#define bh _ml->template fpfield<13>(_iml)
#define bh_columnindex 13
...
static void register_nmodl_text_and_filename(int mechtype);
 ...
 {"setdata_Kv33", _hoc_setdata},
 {"rates_Kv33", _hoc_rates},
 {0, 0}
};
 ...
 hoc_register_parm_default(_mechtype, &_parm_default);
  ...
  register_nmodl_text_and_filename(_mechtype);
   ...
   _nrn_mechanism_register_data_fields(_mechtype,
                                       ...
                                       _nrn_mechanism_field<double>{"am"} /* 10 */,
                                       _nrn_mechanism_field<double>{"bm"} /* 11 */,
                                       _nrn_mechanism_field<double>{"ah"} /* 12 */,
                                       _nrn_mechanism_field<double>{"bh"} /* 13 */,
  ...
  hoc_register_dparam_semantics(_mechtype, 3, "cvodeieq");
    ...
    hoc_register_var(hoc_scdoub, hoc_vdoub, hoc_intfunc);
 	ivoc_help("help ?1 Kv33 /home/raven/PycharmProjects/Masters_model/Mod_Files_Beining_2017/Kv33.mod\n");
...
static int  rates ( _internalthreadargsproto_ ) {
    am = 7.344 / ( 1.0 + exp ( - 0.0807 * ( v - 61.6 ) ) ) ;
   bm = 0.611 / ( 1.0 + exp ( 0.08625 * ( v + 33.0 ) ) ) ;
   mTau = 1.0 / ( am + bm ) ;
   mInf = am * mTau ;
   hInf = Rinact + ( 1.0 - Rinact ) / ( 1.0 + exp ( ( ( v - ( - 29.7 ) ) / ( 25.0 ) ) ) ) ;
   ah = 0.0066 / ( 1.0 + exp ( ( ( v - ( 10.0 ) ) / ( - 6.0 ) ) ) ) ;
   bh = 0.01 / ( 1.0 + exp ( ( ( v - ( - 20.0 ) ) / ( 8.0 ) ) ) ) ;
   hTau = 1.0 / ( ah + bh ) ;
     return 0; }
...
static void register_nmodl_text_and_filename(int mech_type) {
    const char* nmodl_filename = "/home/raven/PycharmProjects/Masters_model/Mod_Files_Beining_2017/Kv33.mod";
