...
class DGGranuleLikeCell:
    ...
    def _set_biophysics(self):
        ...
        #what if add other mechs? try add all & see what change
...
#set baseline conductances
    ...
    def setup_recording(self):
        ...
        #clamp the current - edited out to make second script
...
if __name__ == "__main__":
  ...
  #  h.define_shape()
   ...
   # h.topology()  #keep printing the tree in the console
    ...
    I0 = np.array(cell.iclamp_vec) if cell.iclamp_vec is not None else None  #adds current arrays so can plot
